...
<img width="471" height="706" alt="Screenshot 2026-07-15 163908" src="https://github.com/user-attachments/assets/a03e3998-0dc7-4c94-82b7-20ff86a10dcf" />
...
- Go to **[Releases](https://github.com/Nassami1/thrushield-wallet-main/releases/tag/dist)** and download the latest `dist` package, **or**
...
transaction preview before signing. .⚠️


## ThruShield version

ThruShield Beta v0.1.0.2 — uses `@thru/sdk` 0.3.0 (compatible with alphanet / CLI `thru@0.3.0`).
